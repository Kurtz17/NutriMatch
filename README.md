...
Prototype ini berfokus pada sisi frontend dan pengalaman pengguna. Fitur yang sudah tersedia meliputi tampilan halaman, komponen interaktif, alur onboarding, dashboard, meal plan, dan profile.

Beberapa bagian yang masih bersifat simulasi:

- Data pengguna masih menggunakan mock data.
- Perhitungan nutrisi belum berasal dari backend.
- Rekomendasi makanan belum berasal dari model machine learning asli.
- Login dan register belum memiliki autentikasi sungguhan.
- AI insight masih berupa data contoh.

## Pengembangan Selanjutnya

NutriMatch dapat dikembangkan lebih lanjut dengan:

- Integrasi backend untuk menyimpan data pengguna.
- Autentikasi login dan register.
- Formula nutrisi yang dihitung secara dinamis.
- Sistem rekomendasi makanan berdasarkan database makanan.
- Model AI untuk memberikan rekomendasi dan insight yang lebih personal.
- Validasi alergi berdasarkan bahan makanan dan kategori risiko.

## Kesimpulan

NutriMatch dirancang sebagai solusi awal untuk membantu pengguna mendapatkan rekomendasi meal plan yang lebih personal dan aman. Dengan menggabungkan profil nutrisi, tujuan diet, dan informasi alergi, aplikasi ini dapat menjadi dasar untuk sistem rekomendasi makanan yang lebih cerdas dan relevan bagi kebutuhan pengguna.
